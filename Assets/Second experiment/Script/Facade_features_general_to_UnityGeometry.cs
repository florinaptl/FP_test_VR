...
public class Facade_features_general_to_UnityGeometry : MonoBehaviour
{
    ...
    public Slider _centerLineRange;

    //from slider value to actual value
    public float _procentageOpaqueOfFacade_;
    public float _compactnessOfElement_;
    public float _realSpeed_;
    public float _compactnessOfFacade_;
    public float _boundingRadiusOfElementProc_;
    public float _centerLineRange_;
    ...
    void Update()
    {
        ...
        //from slider value to actual value
        _procentageOpaqueOfFacade_ = _procentageOpaqueOfFacade.value / 10f;
        _compactnessOfElement_ = _compactnessOfElement.value / 10f;
        _realSpeed_ = _realSpeed.value;
        _compactnessOfFacade_ = _compactnessOfFacade.value / 10f;
        _boundingRadiusOfElementProc_ = _boundingRadiusOfElementProc.value / 20f;
        _centerLineRange_ = _centerLineRange.value;
        ...
        compactness_facade_percentage_ = _compactnessOfFacade_;
        centerLineRange_ = (int)_centerLineRange.value;
        ...
        (nrCircles_, nrOfSpots_, elementBoundingRadius_, speed_, nrOfMinimalUnitsPerSpot) = GeneralToUnityGeometry(
                                                                                        ...
                                                                                        _compactnessOfFacade.value / 10f,
        ...
        if (my_severalSpots.myTextArea == "general custom1" || my_severalSpots.myTextArea == "general custom2" || my_severalSpots.myTextArea == "general custom3")
        {
            ...
            {
                //when 0, speed is set to 0.02 and isPlaying=false, so it will keep changeing the speed
                my_severalSpots.speed = speed_;
            }
            ...
            if (my_severalSpots.spotsPosition != (int)centerLineRange_)
            {
                my_severalSpots.spotsPosition = (int)centerLineRange_;
            }
        }
